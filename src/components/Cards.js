...
export default function Cards() {
  return (
    <div>
      <div className="seconddiv h-full w-full">
        <div className="py-4 flex justify-center items-center">
          <div className="text-6xl">
            <p className=" font-web font-semibold"> Meet the Team </p>
          </div>
        </div>
        <div className="relative flex flex-row justify-center">
          <div className="card" data-state="#about">
            <div className="card-header ">
              <div
            //   'https://cdn.dribbble.com/users/887237/screenshots/6086804/sketch_line_icons_with_abstract_background_4x.png?compress=1&resize=1000x750&vertical=top
                className="card-cover"
                style={{backgroundImage: `url("https://cdn.dribbble.com/users/887237/screenshots/6086804/sketch_line_icons_with_abstract_background_4x.png?compress=1&resize=1000x750&vertical=top")`}}
              ></div>
              <img
                ...
                alt="avatar"
              />
              <h1 className="card-fullname text-black font-monte">Harsh Jipkate</h1>
              <h2 className="card-jobtitle text-black py-10 font-monte">
                UI Developer, Owner of the site
              </h2>
            </div>
          ...
          <div className="card" data-state="#about">
            <div className="card-header">
              ...
              <img
                ...
                alt="avatar"
              />
              <h1 className="card-fullname text-black font-monte">Manant Tyagi</h1>
              <h2 className="card-jobtitle text-black py-10 font-monte">
                UI Developer, ramndi
              </h2>
            </div>
          ...
          <div className="card" data-state="#about">
            <div className="card-header">
              ...
              <img
                ...
                alt="avatar"
              />
              <h1 className="card-fullname text-black font-monte">Nikhil Rana</h1>
              <h2 className="card-jobtitle text-black py-10 font-monte">
                UI Developer
              </h2>
            </div>
          ...
          <div className="card" data-state="#about">
            <div className="card-header">
              ...
              <img
                ...
                alt="avatar"
              />
              <h1 className="card-fullname text-black font-monte">Niraj Patidar</h1>
              <h2 className="card-jobtitle text-black py-10 font-monte">
                Lode ka Developer
              </h2>
            </div>
